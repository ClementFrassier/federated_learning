...
def load_data(node_id: int = 0, num_clients: int = 10, batch_size: int = 32):
    ...
    Training set (60 000 images) is divided evenly: each client receives
    a contiguous slice of 60 000 / num_clients images.
    The full test set (10 000 images) is shared across all clients.
    """
