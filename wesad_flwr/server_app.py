...
CSV_DIR  = "resultsfeat"
CSV_FILE = os.path.join(CSV_DIR, "results_wesad_mlp_tiny.csv")
...
def evaluate_metrics_aggregation_fn(record_dicts, weighted_by):
    ...
    # Fairness: std-dev of INT8 accuracy across the 15 WESAD subjects
...
def main(grid: Grid, context: Context) -> None:
    ...
    Strategy: FedProx
      - Handles non-IID data across the 15 WESAD subjects with a proximal term
    ...
    print("\nSaving final model to 'final_model_wesad.pt'...")
    torch.save(result.arrays.to_torch_state_dict(), "final_model_wesad.pt")
