...
\begin{table}[h!]
  ...
  \begin{tabular}{lcc}
    ...
    \textbf{Balanced-accuracy (4 clients informatifs)}\textsuperscript{\ddag} & $\mathbf{42{,}73 \pm 0{,}97\,\%}$ & $\mathbf{45{,}73 \pm 1{,}54\,\%}$ \\
    F1 macro (pooled, 15 clients) & $45{,}4 \pm 0{,}2\,\%$           & $58{,}56 \pm 1{,}26\,\%$ \\
    \textbf{AUC-ROC (4 clients informatifs)}\textsuperscript{\ddag} & $\mathbf{0{,}2047 \pm 0{,}0232}$ & $\mathbf{0{,}2669 \pm 0{,}0197}$ \\
...
\begin{table}[h!]
  ...
  \begin{tabular}{lccc}
    ...
    \textbf{Balanced-accuracy (4 clients informatifs)}\textsuperscript{\ddag} & $\mathbf{45{,}73 \pm 1{,}54\,\%}$ & $\mathbf{45{,}18 \pm 2{,}38\,\%}$ & $\mathbf{42{,}73 \pm 0{,}97\,\%}$ \\
...
à peine au-dessus du hasard, et son AUC-ROC à $0{,}2669 \pm 0{,}0197$, \textbf{en
dessous du hasard}. Le balayage de seuil de décision (de $10^{-3}$ à $0{,}99$, sur les
probabilités déjà produites, aucun réentraînement) est sans appel : le seuil optimal du
centralisé se replie lui aussi sur $0{,}001$ (prédire ``stress'' quasi systématiquement),
plafonnant à \emph{exactement} $50{,}00 \pm 0{,}00\,\%$ -- la signature précise d'une
absence totale de signal exploitable, identique à celle que ce document attribuait
jusqu'ici au FL seul. Le FL+DP, sur ces mêmes 4 clients, fait à peine moins bien
(balanced-accuracy $42{,}73 \pm 0{,}97\,\%$, AUC $0{,}2047 \pm 0{,}0232$, meilleur seuil
également $0{,}001$, plafond à $46{,}98 \pm 1{,}28\,\%$ -- sans même atteindre le plancher
théorique). \textbf{Le message central de ce document change en conséquence} : il ne
s'agit pas de ``pourquoi le centralisé résout un problème que le FL ne résout pas'',
mais de ``pourquoi aucune des deux architectures ne généralise sur les clients les plus
atypiques'' -- l'écart réel entre les deux (3 à 5 points de balanced-accuracy selon la
métrique) est un désavantage marginal du FL par-dessus un problème de fond commun aux
...
\begin{table}[h!]
  ...
  \begin{tabular}{lcc}
    ...
    \textbf{Balanced-accuracy (4 clients informatifs)}\textsuperscript{\ddag} & $\mathbf{42{,}73 \pm 0{,}97\,\%}$ & $\mathbf{48{,}44 \pm 3{,}65\,\%}$ \\
    \textbf{AUC-ROC (4 clients informatifs)}\textsuperscript{\ddag} & $\mathbf{0{,}2047 \pm 0{,}0232}$ & $\mathbf{0{,}4417 \pm 0{,}1022}$ \\
...
architectures, pas un problème propre au FL.
