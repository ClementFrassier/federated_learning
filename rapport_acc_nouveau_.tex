...
0{,}0125$) est donc appliquée par prudence. Trois des quatre comparaisons y survivent
(durée, réseau entier, $p=1{,}3\times10^{-3}$ ; durée, tête seule, $p=1{,}2\times10^{-2}$ ;
granularité, 8 époques, $p=6{,}2\times10^{-3}$) ; seule la granularité à 30 époques
($p=2{,}2\times10^{-2}$) ne survit pas au seuil corrigé. Cela n'invalide pas la
conclusion sur la granularité, déjà solidement établie par la comparaison à 8 époques,
mais tempère la certitude statistique de sa réplication à 30 époques précisément.
...
\begin{itemize}
  ...
  $p<0{,}03$) -- personnaliser uniquement la tête surpasse nettement le fine-tuning
  du réseau entier, à extracteur de départ identique -- et la durée compte aussi,
  plus modestement (+1 à +2 points, $p<0{,}02$). Deux corrections successives ont été
